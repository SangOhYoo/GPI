...
def build_prompt_augmentation_instruction(keyword_text=None, model_name=None, active_character_ids=None, pose_override=None, expression_override=None):
    ...
    instr = (
        ...
        '      "environment": {\n'
        '        "setting": "string",\n'
        '        "foreground": "string (framing objects and near-camera elements with soft depth blur)",\n'
        '        "midground": "string (main action stage, key props, and focal plane items)",\n'
        '        "background": "string (distant backdrop, architecture, and horizon)",\n'
                ...
                def _flatten(obj, prefix=""):
                    if isinstance(obj, dict):
                        ...
                        if obj and all(not isinstance(x, (dict, list)) for x in obj):
                            ...
                            elif "spatial" in p_lower or "layout" in p_lower:
                        ...
                        if obj is not None and str(obj).strip():
                            ...
                            if "expression" in p_lower:
                                ...
                                attributes["Props_Environment_Details"][prefix] = s_val
                            elif "camera" in p_lower or "lens" in p_lower or "orbit" in p_lower or "azimuth" in p_lower or "elevation" in p_lower or "z_index" in p_lower or "depth" in p_lower or "distance" in p_lower or "spatial" in p_lower:
                                attributes["Camera"][prefix] = s_val
